...
#' @export
#'
radical <- function(X, components = NCOL(X), demean = TRUE, pca_cov = c("Sample", "LS-ID", "LS-CC", "LS-MKT", "NLS-GIS", "NLS-LIS", "NLS-QIS", "EWMA"),
                    ...
                    Z = NULL, K = NULL, L = NULL, seed = NULL, trace = FALSE, ...)
{
    ...
    pca_cov <- match.arg(pca_cov[1], c("Sample", "LS-ID", "LS-CC", "LS-MKT", "NLS-GIS", "NLS-LIS", "NLS-QIS", "EWMA"))
    if (demean) {
...
fastica <- function(X, components = NCOL(X), demean = TRUE, method = "symmetric",
                    pca_cov = c("Sample", "LS-ID", "LS-CC", "LS-MKT", "NLS-GIS", "NLS-LIS", "NLS-QIS", "EWMA"), first_eigen = NULL, last_eigen = NULL, E = NULL, D = NULL,
